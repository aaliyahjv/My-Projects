...
intro_tab <- tabPanel(
  ...
  p('Adler, S. E. (2022, August 10). Positive effects of music for Mental 
    ...
    a(href = 'https://www.aarp.org/health/brain-health/info-2020/music-mental-
      health.html', 'https://www.aarp.org/health/brain-health/info-2020/music-
      mental-health.html', .noWS = 'outside'), '.', .noWS = c("after-begin", 
                                                              "before-end")),
